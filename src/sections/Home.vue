  ...
  <section id="home" class="min-h-screen px-5 lg:px-28 pt-6 pb-16 lg:pt-6 flex items-center relative overflow-hidden">
    ...
    >
      <a
        ...
        href="mailto:abhiii.1818@gmail.com"
        aria-label="Email"
      >
        <span class="social-circle">
          <i class="bi bi-envelope-at text-lg"></i>
        </span>
        <span class="social-label">abhiii.1818@gmail.com</span>
      </a>
      <a
        class="social-item group"
        href="https://www.linkedin.com/in/abhiram-bhuvanagiri-394a4a377/"
        aria-label="LinkedIn"
        target="_blank"
      ...
      >
        ...
        <span class="social-label">abhiram-bhuvanagiri</span>
      </a>
      <a
        class="social-item group"
        href="https://github.com/Abhiram-Bhuvanagiri"
        aria-label="GitHub"
        target="_blank"
        rel="noopener noreferrer"
      >
...
const sectionIds = ["home", "about", "experience", "statement", "contact"];
...
const localizedWords = computed(() => {
  const w = tm("home.words");
...
const startWordRotation = () => {
  if (timerId) return;
  timerId = setInterval(() => {
    const w = localizedWords.value;
    wordIndex = (wordIndex + 1) % w.length;
    currentWord.value = w[wordIndex];
  }, WORD_ROTATE_MS);
};
