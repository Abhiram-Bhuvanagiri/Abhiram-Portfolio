...
const projects = computed(() => [
  {
    id: "stock-market-app",
    title: t('projects.stockApp'),
    tags: [t('projects.stockAppSubtitle')],
  },
  {
    id: "voice-interview-simulation",
    title: t('projects.voiceApp'),
    tags: [t('projects.voiceAppSubtitle')],
  },
  {
    id: "job-application-bot",
    title: t('projects.botApp'),
    tags: [t('projects.botAppSubtitle')],
  }
]);
...
const goToProject = (project) => {
  ...
  const navigate = () => {
    router.push({ name: "project-progress", params: { id: project.id }, query: { from: fromSection } });
  };
